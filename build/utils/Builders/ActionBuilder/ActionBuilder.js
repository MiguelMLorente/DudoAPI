...
var JoinGameActionBuilder_1 = require("./JoinGameActionBuilder");
    ...
    ActionBuilder.prototype.build = function () {
        switch (this.jsonAction.actionType) {
            ...
            case ActionType_1.ActionType.JOIN_GAME:
                return new JoinGameActionBuilder_1.JoinGameActionBuilder(this.jsonAction, this.serverData, this.requester).build();
            default:
                return new BidActionBuilder_1.BidActionBuilder(this.jsonAction, this.serverData, this.requester).build();
        }
    };
